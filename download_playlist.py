...
for download_tracklist in export_tracklists:
    stripped_title = PLAYLIST_FOLDER_RE.match(str(download_tracklist)).group(2)
    ...
    tracklist_items = download_tracklist.items
    remaining_items = {}
    ...
    print ("**** Exporting %s" % str(download_tracklist))
    ...
    if DELETE_REMOVED_TRACKS:
        ...
        assert len(tracklist_items) > len(remaining_items)
